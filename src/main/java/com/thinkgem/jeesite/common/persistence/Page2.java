...
public class Page2<Object> {
	 ...
	 */
	public Page2(HttpServletRequest request, HttpServletResponse response){
	 ...
	 */
	public Page2(HttpServletRequest request, HttpServletResponse response, int defaultPageSize){
	 ...
	 * @param pageSize 分页大小
	 */
	public Page2(int pageNo, int pageSize) {
	 ...
	 * @param count 数据条数
	 */
	public Page2(int pageNo, int pageSize, long count) {
	 ...
	 * @param list 本页数据对象列表
	 */
	public Page2(int pageNo, int pageSize, long count, List<Map<String,Object>> list) {
		this.setCount(count);
...
//	}
	 ...
	 * @param list
	 */
	public Page2<Object> setList(List<Map<String,Object>> list) {
		this.list = list;
		initialize();
		return this;
	}
