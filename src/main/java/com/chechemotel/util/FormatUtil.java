...
public final class FormatUtil {
	 ...
	 * @return
	 */
	public static String formatDoubleRound2fStr(String tkje)
	{
		if(tkje==null)
		{
			tkje="0";
		}
		BigDecimal b=new BigDecimal(tkje);
		//保留2位小数
		//double   f1  =b.setScale(2,BigDecimal.ROUND_HALF_UP).doubleValue(); 
		String   tkjeStr  =b.setScale(2,BigDecimal.ROUND_HALF_UP).toString();
		return tkjeStr;
	}
	public static String formatDoubleRound2fStr(double tkje)
	{
		BigDecimal b=new BigDecimal(tkje);
		//保留2位小数
		//double   f1  =b.setScale(2,BigDecimal.ROUND_HALF_UP).doubleValue(); 
	...
	public static double formatDoubleRound2f(String tkje)
	{
		if(tkje==null)
		{
			tkje="0";
	...
	public static double formatDoubleRound2f(double tkje)
	{
		BigDecimal b=new BigDecimal(tkje);
		//保留2位小数
		double   f1  =b.setScale(2,BigDecimal.ROUND_HALF_UP).doubleValue(); 
